                      ...
                      Error **errp)
{
    ...
    if (bs->job) {
        ...
        /* Do not complete the switch if the job had an I/O error
         * or was canceled (i.e. the target was not synchronized
         * completely).
         */
        if (ret != 0) {
                      ...
                      bool has_speed, int64_t speed, Error **errp)
{
    ...
    mirror_start(bs, target, drv, flags,
                 speed, full, block_job_cb, bs, errp);
}
